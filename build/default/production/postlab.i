...
push:
    ...
    MOVWF STATUS_TEMP
isr:
    btfsc ((INTCON) and 07Fh), 2 ;revisamos las banderas de las interrupciones y ejecutamos subrutinas de interrupción en respuesta
    call int_T0
    call limit_checkD
...
config_tmr0:
    ...
    BCF ((OPTION_REG) and 07Fh), 0 ; PS<2:0> -> preescaler 100 1:32
